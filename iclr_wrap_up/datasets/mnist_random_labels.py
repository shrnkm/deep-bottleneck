...
def load():
    ...
    Returns:
        ...
        Important Note: Labels both for test and training are randomly shuffled, which renders this dataset
        prohibitive to use in a "real" context, it is rather intended for experiments regarding the
        generalization capabilities of deep neural nets trained with SGD
    """
